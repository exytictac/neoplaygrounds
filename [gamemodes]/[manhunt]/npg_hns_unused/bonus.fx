...
{ 
	...
	if (Color.r<0.4 || Color.r>0.7) Color.r = 0; else Color.r = 1.0f; 
	if (Color.g<0.4 || Color.g>0.7) Color.g = 0; else Color.g = 1.0f; 
	if (Color.b<0.4 || Color.b>0.7) Color.b = 0; else Color.b = 1.0f;
    return Color; 
};
