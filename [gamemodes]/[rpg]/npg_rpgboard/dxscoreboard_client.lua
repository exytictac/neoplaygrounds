...
triggerKey = "b" -- default button to open/close scoreboard
...
addEventHandler( "onClientResourceStart", getResourceRootElement( getThisResource() ), 
	function ( resource )
		...
		bindKey( triggerKey, "down", "Toggle RPG board", "1" )
		bindKey( triggerKey, "up", "Toggle RPG board", "0" )
		bindKey( settingsKey, "down", "Open RPG board settings", "1" )
...
addCommandHandler( "Toggle RPG board", toggleScoreboard )
...
addCommandHandler( "Open RPG board settings", openSettingsWindow )

addCommandHandler( "rpgboard", 
	function ()
		scoreboardToggled = not scoreboardToggled
	end
)
	...
	if #scoreboardColumns ~= 0 then
		...
		if scoreboardDrawn then
			...
			if serverInfo.players and showServerInfo then
				local players = getPlayersInGamemode( "rpg" )
...
addEvent( "doRPGboardAddColumn", true )
addEventHandler( "doRPGboardAddColumn", getResourceRootElement(),
...
addEvent( "doRPGboardRemoveColumn", true )
addEventHandler( "doRPGboardRemoveColumn", getResourceRootElement(),
	function ( name )
...
addEvent( "doRPGboardClearColumns", true )
addEventHandler( "doRPGboardClearColumns", getResourceRootElement(),
	function ()
...
addEvent( "doRPGboardResetColumns", true )
addEventHandler( "doRPGboardResetColumns", getResourceRootElement(),
	function ( fromServer )
...
addEvent( "doRPGboardSetForced", true )
addEventHandler( "doRPGboardSetForced", getResourceRootElement(),
	function ( forced )
...
addEvent( "doRPGboardSetSortBy", true )
addEventHandler( "doRPGboardSetSortBy", getResourceRootElement(),
	function ( name, desc )
...
addEvent( "doRPGboardSetColumnPriority", true )
addEventHandler( "doRPGboardSetColumnPriority", getResourceRootElement(),
